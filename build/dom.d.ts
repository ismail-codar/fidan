...
export declare const arrayMap: <T>(arr: FidanArray<T>, parentDom: Node & ParentNode, nextElement: Element, renderReturn: (item: any, idx?: number, isInsert?: boolean) => Node, reuseMode?: boolean) => void;
